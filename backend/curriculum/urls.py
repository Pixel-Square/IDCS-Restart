...
router.register(r'field-schemas', CurriculumFieldSchemaViewSet, basename='curriculum-field-schemas')
...
urlpatterns = [
    ...
    path('regulations/', CurriculumRegulationsView.as_view(), name='curriculum-regulations'),
