...
from .views import (
    ...
    admin_faculty_request_settings,
...
urlpatterns = [
    ...
    path('google-sheets/links/', google_sheet_links, name='google-sheet-links'),
    ...
    path('faculty/courses/<int:ta_id>/co-attainment/', faculty_course_coattainment, name='faculty-course-coattainment'),
    ...
    path('admin/faculty-request-settings/', admin_faculty_request_settings, name='admin-faculty-request-settings'),
