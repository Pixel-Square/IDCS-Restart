...
# IN-MEMORY SAVED DASHBOARDS STORE (Persisted definition configurations, NOT static student marks data)
DASHBOARDS_STORE = {
    "dash-001": {
        "id": "dash-001",
        "name": "Student Academic Performance Dashboard",
        "department": "CSE",
        ...
        "visuals": [
            ...
            {
                "id": "vis-kpi-3",
                "title": "Evaluated Student Records",
                "type": "kpi",
                "dataset": "student_marks",
                "category": "student_name",
                "measure": "marks_obtained",
            ...
            {
                "id": "vis-chart-1",
                "title": "Student Marks by Subject (Grouped)",
                "type": "column",
                "dataset": "student_marks",
                "category": "student_name",
                "measure": "marks_obtained",
            ...
            {
                "id": "vis-table-1",
                "title": "Student Performance Details Table",
                "type": "table",
                "dataset": "student_marks",
                "category": "student_name",
                "measure": "marks_obtained",
