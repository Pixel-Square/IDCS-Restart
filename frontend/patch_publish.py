...
request_control_code = """import { useEffect, useState } from 'react';
...
with open('/home/iqac/IDCS-Restart/frontend/src/utils/requestControl.ts', 'w') as f:
    f.write(request_control_code)


publish_code = """import React, { useEffect, useMemo, useState } from 'react';
...
with open('/home/iqac/IDCS-Restart/frontend/src/pages/iqac/AcademicControllerPublishPage.tsx', 'w') as f:
    f.write(publish_code)
