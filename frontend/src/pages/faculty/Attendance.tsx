    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Faculty Attendance Management</h1>
            <p className="text-gray-600 mt-1">View and analyze faculty attendance across departments</p>
          </div>
        </div>
