...
export default function IQACStaffAttendancePage() {
  ...
  useEffect(() => {
    if (selectedDepartment !== null && selectedDate) {
  ...
  const selectedDeptName = departments.find(d => d.id === selectedDepartment)?.name || 'All Departments';
    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Staff Attendance Management</h1>
            <p className="text-gray-600 mt-1">View and analyze staff attendance across departments</p>
          </div>
        </div>
          ...
          <div className="border-t pt-6">
            ...
            {selectedDate && (
              <p className="text-sm text-gray-600 mb-4">
                Showing attendance for <strong>{formatDate(selectedDate)}</strong> in <strong>{selectedDeptName}</strong>
              </p>
            )}
              ...
              return todaysRecords.length > 0 ? (
                ...
                <div className="bg-gray-50 rounded-lg p-12 text-center">
                  ...
                  <p className="text-gray-600">
                    No attendance records found for the selected date and department.
                  </p>
                </div>
              );
            })()}
