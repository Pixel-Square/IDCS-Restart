...
export const PAGE_REGISTRY: PageEntry[] = [
  ...
  { path: '/pbas/staff',                 label: 'PBAS Submission',               icon: 'PenLine',       group: 'Staff',    roles: ['STAFF', 'STUDENT'] },
  { path: '/pbas/admin',                 label: 'PBAS Admin',                    icon: 'ClipboardList', group: 'Admin',    roles: ['PBAS_ADMIN', 'PBASADMIN', 'PBAS_MANAGER', 'IQAC', 'ADMIN'] },
  { path: '/pbas/approvals',             label: 'PBAS Approvals',                icon: 'UserCheck',     group: 'Admin',    roles: ['PBAS_APPROVER', 'PBAS_ADMIN', 'PBAS_MANAGER', 'PBASADMIN', 'IQAC', 'ADMIN', 'PRINCIPAL', 'PS'] },
